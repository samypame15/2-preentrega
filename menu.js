...
const productos = [
    new Producto("Torta de Chocolate", 120, 5, true, "https://via.placeholder.com/150"),
    new Producto("Cheesecake de Queso", 200, 10, true, "https://via.placeholder.com/150"),
    new Producto("Desayunos Sorpresas", 180, 1, true, "https://via.placeholder.com/150"),
    new Producto("Cajas de Donas y Paletas de Chocolates", 220, 4, true, "https://via.placeholder.com/150")
];
...
productos.forEach(producto => {
    ...
    productoDiv.querySelector('button').addEventListener('click', () => {
        producto.vender(1);
        productoDiv.querySelector('p:nth-child(4)').textContent = `Stock: ${producto.stock}`;
        if (producto.stock === 0) {
